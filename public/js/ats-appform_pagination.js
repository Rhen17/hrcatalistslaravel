...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const pagePaths = {
    'app-form-page-1.html': { next: 'app-form-page-2.html', back: null },
    'app-form-page-2.html': { next: 'app-form-page-3.html', back: 'app-form-page-1.html' },
    'app-form-page-3.html': { next: 'app-form-page-4.html', back: 'app-form-page-2.html' },
    'app-form-page-4.html': { next: null, back: 'app-form-page-3.html' },
  };
